...
def obter_recordes():
    # Retorna o dicionário convertido em lista estruturada
...
# Dividimos o código em blocos menores e juntamos com o operador '+' para evitar cortes de texto
PARTE_ESTILO = """<!DOCTYPE html>
<html lang="pt-BR">
<head>
    <meta charset="UTF-8">
